...
namespace ProductAPI.Data
{
    public class ProductDbContext : IdentityDbContext<ApplicationUser, IdentityRole<Guid>, Guid>
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            string connectionString = $"Server={server};Database={db};User Id= {userName};Password={password};MultipleActiveResultSets=true;TrustServerCertificate=True"; /*TrustServerCertificate = true*/
